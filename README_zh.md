...
- [src/template/dest/environments/{each environments as environment}/{hyphen environment.name}/{each environment.deployments as deployment}/{if (eq deployment.type 'postgres_container_deployment')}/docker-compose@services@.yaml.hbs](<./src/template/dest/environments/{each environments as environment}/{hyphen environment.name}/{each environment.deployments as deployment}/{if (eq deployment.type 'postgres_container_deployment')}/docker-compose@services@.yaml.hbs>)
